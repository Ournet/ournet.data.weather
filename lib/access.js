...
var Service = module.exports = function(options) {
	this.options = _.defaults({}, options || {}, { alarms: true, history: false });
};
							...
							try {
								alarms.findAndSave(selector.place, newreport.days[1])
									...
									.catch(function(findError) {
										logger.error('Catched Error on getting alarms:' + (findError.message || 'NO MESSAGE'), findError, newreport.days[1], selector.place.id);
									});
							} catch (alarmsError) {
